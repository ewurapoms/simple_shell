...
/**
  * perrorl - function prints formatted message to standard error
...
/**
  * perrorl_default - function prints formatted message to standard error
  * @arg0: is an argument
  * @lineno: is the line num
...
/**
 * atou - function converts a str to an int
